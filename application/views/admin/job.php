                ...
                <tbody>
                  ...
                  <?php foreach ($job as $r) : ?>
                    <tr>
                      ...
                      <td><?=$r['job']; ?></td>
                      <td >
                         <a href="<?=base_url('admin/editJob/') ?>" id="<?= $r['id'] ?>"  data-toggle="modal" data-target="#editModal" class="badge badge-success view_data">Edit</a> <!--class ini dpt getboostrap cari aja pils & pilih yg links-->
                          <a href="<?=base_url('job/delete/').$r['id']; ?>" class="badge badge-danger tombol-hapus">Delete</a> 
                      </td>
                    </tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?=base_url('job/save') ?>" method="post" class="form-horizontal">
            <div class="form-group">
              <label>Job Name</label>
              <input class="form-control" type="text" name="job" id="job" placeholder="Job Name">
            </div>
          </div>
